...
export const DashboardHeader = ({
    ...
    return (
        <>
            ...
            <div className="md:hidden relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-gray-900/80 via-black/60 to-gray-900/80 backdrop-blur-xl mt-14 p-4 shadow-xl animate-in fade-in slide-in-from-top-4 duration-500">
                    ...
                    <div className="flex items-center justify-between gap-3">
                        <div className="flex-1 min-w-0">
                            ...
                            <h1 className="bg-gradient-to-r from-green-700 via-green-400 to-white bg-clip-text text-xl font-extrabold text-transparent truncate">
                                {userName ? userName.charAt(0).toUpperCase() + userName.slice(1) : t.dashboardTitle}
                            </h1>
                        </div>
                    </div>
