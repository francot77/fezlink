...
import { Mail, User, Lock, Loader2, Check, X, Github, Chrome, Sparkles, ArrowRight } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-gray-950 via-black to-gray-900">
            ...
            <div className="pointer-events-none fixed inset-0">
                <div className="absolute left-1/4 top-20 h-96 w-96 rounded-full bg-emerald-500/10 blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
                <div className="absolute right-1/4 bottom-20 h-96 w-96 rounded-full bg-cyan-500/10 blur-3xl animate-pulse" style={{ animationDuration: '6s', animationDelay: '1s' }} />
                <div className="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-500/10 blur-3xl animate-pulse" style={{ animationDuration: '5s', animationDelay: '2s' }} />
            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute right-4 top-1/2 -translate-y-1/2">
                                        {checkingUsername && <Loader2 size={18} className="animate-spin text-cyan-400" />}
                            ...
                            >
                                <span className="relative z-10 flex items-center justify-center gap-2">
                                    {loading ? (
                                        ...
                                        <>
                                            Create account
                                            <ArrowRight size={20} className={isFormValid ? 'transition-transform group-hover:translate-x-1' : ''} />
                                        </>
                                    )}
                                </span>
                                {isFormValid && (
