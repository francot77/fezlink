...
const translations: Record<SupportedLanguage, { [key: string]: string }> = {
    en: {
        ...
        premiumLabel: 'Manage subscription',
        premiumDescription: 'Control billing and access advanced capabilities',
        loading: 'Loading...',
        viewing: 'Viewing',
        language: 'Language',
    },
    es: {
        ...
        premiumLabel: 'Gestionar suscripción',
        premiumDescription: 'Controla la facturación y accede a funciones avanzadas',
        loading: 'Cargando...',
        viewing: 'Viendo',
        language: 'Idioma',
    },
            ...
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 pt-10">
                <div className="flex flex-col gap-4 rounded-2xl border border-gray-800/80 bg-gray-900/60 p-6 shadow-2xl shadow-blue-900/20 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                        <div className="flex w-full items-center justify-between gap-2 rounded-full border border-gray-700 px-2 py-1 text-xs text-gray-200 sm:w-auto sm:px-3">
                        ...
                        <Link
                            href="/"
                            className="flex items-center justify-center gap-2 rounded-full border border-gray-700 px-4 py-2 text-sm text-gray-200 transition hover:border-blue-500 hover:text-white"
                        >
                            <Home size={16} /> {t.home}
                        </Link>
                    </div>
