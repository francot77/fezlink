...
export default function BioPageClient({ initialBioPage }: Props) {
  ...
  if (!bioPage) {
    return <div className="text-red-400 p-4">Esta página no existe o ha sido eliminada.</div>;
  }
      ...
      <div className="w-full max-w-4xl">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 shadow-2xl">
          ...
          {bioPage.background?.image?.url && (
            <div className="absolute inset-0 bg-center bg-cover z-0" style={backgroundImageStyle} />
          )}
