...
export const BIOPAGE_TRANSLATIONS: Record<SupportedLanguage, { [key: string]: string }> = {
  en: {
    ...
    invalidFormat: 'Only letters, numbers, hyphens and underscores allowed',
  },
  es: {
    loading: 'Cargando...',
    ...
    minChars: 'Mínimo 3 caracteres requeridos',
    invalidFormat: 'Solo se permiten letras, números, guiones y guiones bajos',
  },
};
