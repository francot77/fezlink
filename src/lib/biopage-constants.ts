...
export const DEFAULT_AVATAR = 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png?20150327203541';
...
export const GRADIENT_PRESETS = [
    ...
    { label: 'Emerald Glow', value: 'linear-gradient(135deg, #064e3b 0%, #10b981 50%, #6ee7b7 100%)' },
    { label: 'Purple Storm', value: 'linear-gradient(135deg, #312e81 0%, #7c3aed 50%, #c084fc 100%)' },
    ...
    { label: 'Crimson Night', value: 'linear-gradient(135deg, #020617 0%, #7f1d1d 50%, #dc2626 100%)' },
    ...
    { label: 'Electric Lime', value: 'linear-gradient(135deg, #4d7c0f 0%, #84cc16 50%, #d9f99d 100%)' },
