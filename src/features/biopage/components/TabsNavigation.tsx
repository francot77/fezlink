import { Droplet, Sparkles, Image as ImageIcon } from 'lucide-react';
      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 rounded-lg px-3 py-2 text-xs sm:text-sm font-medium transition-all duration-300 ${
              activeTab === tab.id
