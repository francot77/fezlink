    ...
    <SectionCard title={t.profileTitle} description={t.profileDescription} icon={User}>
      <div className="grid gap-6 md:grid-cols-[auto,1fr] md:items-start">
        <button
          ...
          className="group/avatar relative w-32 h-32 rounded-2xl overflow-hidden ring-2 ring-emerald-400/50 shadow-xl shadow-emerald-500/20 transition-all duration-300 hover:scale-105 hover:ring-emerald-400"
        >
          <img
          ...
          />
          <span className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm opacity-0 transition-opacity duration-300 group-hover/avatar:opacity-100">
