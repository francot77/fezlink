    ...
    return createPortal(
        ...
        >
            <div
                ...
                className={`relative w-full ${isStats ? 'max-w-6xl' : 'max-w-md'} max-h-[90vh] flex flex-col transform transition-all duration-300 ${isVisible ? 'scale-100 opacity-100 translate-y-0' : 'scale-95 opacity-0 translate-y-4'
                    }`}
                tabIndex={-1}
            >
